...
use libc::FILE;
#[derive(Debug, Clone, Copy)] #[repr(C, align(16))] pub struct c_longdouble([u64; 2]); use c_longdouble as u128;
use super::{MIR_op_t, MIR_insn, MIR_val_t};
...
unsafe extern "C" {
    pub fn MIR_new_ldouble_op(ctx: MIR_context_t, v: u128) -> MIR_op_t;
}
unsafe extern "C" {
